/******************************************************************************
 *
 * This file autogenerated from ppe_utests.yml on 2018-12-12 13:24:56.309135.
 *
...
ucli_block_t ppe_utests[] = 
{
  ...
  },
  {
    "IGMP", 
    {
      "data 01005e01010100112233445508004500001c00010000400295d701020304e001010111140de9e0010101", 
      "chm IGMP true", 
      "check IGMP_TYPE == 0x11", 
      "check IGMP_MAX_RESP_TIME == 0x14", 
      "check IGMP_CHECKSUM == 0x0de9", 
      "check IGMP_GROUP_ADDRESS == 0xe0010101", 
    },
  },
  {
    "PIM", 
    {
      "data 01005e00000d000102030405080045000018000100004067986f01010101e000000d2000dfff", 
      "chm PIM true", 
      "check PIM_VERSION == 2", 
      "check PIM_TYPE == 0", 
      "check PIM_CHECKSUM == 0xdfff", 
    },
  },
  {
    "PIM_NULL_REGISTER", 
    {
      "data 00000100000100109400000208004500001400000000ff673a2ac0550102c000000121009eff400000004500001400000000fffd1793c0550102e1010101", 
      "chm PIM true", 
      "chm PIM_REGISTER true", 
      "check PIM_VERSION == 2", 
      "check PIM_TYPE == 1", 
      "check PIM_CHECKSUM == 0x9eff", 
      "check PIM_REGISTER_B == 0", 
      "check PIM_REGISTER_N == 1", 
      "checkw PIM_REGISTER_DATA == 4500001400000000fffd1793c0550102e1010101", 
    },
  },
  {
    "PIM_REGISTER_STOP_V4", 
    {
      "data {cc06061cf001}{cc05061cf000}{0800}{45c0002602820000ff6734dac0a801fec0a80006}{22001628}{01000020ef0102030100c0a8140a}", 
      "chm PIM true", 
      "chm PIM_REGISTER_STOP_V4 true", 
      "check PIM_VERSION == 2", 
      "check PIM_TYPE == 2", 
      "check PIM_CHECKSUM == 0x1628", 
      "check PIM_REGISTER_STOP_V4_ENCODED_GRP_ADDR == 0xef010203", 
      "check PIM_REGISTER_STOP_V4_ENCODED_UNI_ADDR == 0xc0a8140a", 
    },
  },
  {
    "IP6_HEADER", 
    {
      "data {00AB298C3E00}{3333FF11777F}{8100}{03FE}{86DD}{651122334455667720010DB8AAAA000102AB29FFFE8C3E00FF0200000000000000000001FF11777F}", 
      "check ETHER_TYPE == 0x86DD", 
      "check IP6_VERSION == 6", 
      "check IP6_TRAFFIC_CLASS_U == 5", 
      "check IP6_TRAFFIC_CLASS_L == 1", 
      "check IP6_FLOW_LABEL_U == 1", 
      "check IP6_FLOW_LABEL_L == 0x2233", 
      "check IP6_PAYLOAD_LENGTH == 0x4455", 
      "check IP6_NEXT_HEADER == 0x66", 
      "check IP6_HOP_LIMIT == 0x77", 
      "checkw IP6_SRC_ADDR == 20010DB8AAAA000102AB29FFFE8C3E00", 
      "checkw IP6_DST_ADDR == FF0200000000000000000001FF11777F", 
      "missing IP4_VERSION", 
    },
  },
  {
    "ICMP6_HEADER", 
    {
      "data 005056e01449000c29340bde86dd6000000100143a4000020000000000000000000000000002000200000000000000000000000000018500117600000000010100ab298c3e00", 
      "chm IP6 true", 
      "chm ICMPV6 true", 
      "check ICMPV6_TYPE == 0x85", 
      "check ICMPV6_CODE == 0x00", 
