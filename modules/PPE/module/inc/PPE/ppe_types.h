...
typedef enum ppe_field_e {
    ...
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_B,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_RSVD,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_Z,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_MASK,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_ADDR,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_UNI_AF,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_UNI_TYPE,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_UNI_ADDR,
    PPE_FIELD_PIM_JOIN_PRUNE_DATA,
