...
typedef enum ppe_field_e {
    ...
    PPE_FIELD_PIM_TYPE,
    PPE_FIELD_PIM_RESERVED,
    PPE_FIELD_PIM_CHECKSUM,
    PPE_FIELD_PIM_REGISTER_B,
    PPE_FIELD_PIM_REGISTER_N,
    PPE_FIELD_PIM_REGISTER_RESERVED,
    PPE_FIELD_PIM_REGISTER_DATA,
    PPE_FIELD_PIM_HELLO_RAW_DATA,
    PPE_FIELD_PIM_REGISTER_REGISTER_B,
    PPE_FIELD_PIM_REGISTER_REGISTER_N,
    PPE_FIELD_PIM_REGISTER_REGISTER_RESERVED,
    PPE_FIELD_PIM_REGISTER_RAW_DATA,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_AF,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_TYPE,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_RSVD,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_SM,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_WC,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_RPT,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_MASK,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_GRP_ADDR,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_SRC_AF,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_SRC_TYPE,
    PPE_FIELD_PIM_REGISTER_STOP_V4_ENCODED_SRC_ADDR,
    PPE_FIELD_PIM_JOIN_PRUNE_RAW_DATA,
...
typedef enum ppe_header_e {
    ...
    PPE_HEADER_IGMP,
    PPE_HEADER_PIM,
    PPE_HEADER_PIM_HELLO,
    PPE_HEADER_PIM_REGISTER,
    PPE_HEADER_PIM_REGISTER_STOP_V4,
    PPE_HEADER_PIM_JOIN_PRUNE,
    PPE_HEADER_BFD,
