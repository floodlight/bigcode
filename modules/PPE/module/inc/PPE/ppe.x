...
PPE_FIELD_ENTRY(PIM, RESERVED, 8, 1, 0)
PPE_FIELD_ENTRY(PIM, CHECKSUM, 16, 2, 0)
PPE_FIELD_ENTRY(PIM, REGISTER_B, 1, 4, 7)
PPE_FIELD_ENTRY(PIM, REGISTER_N, 1, 4, 6)
PPE_FIELD_ENTRY(PIM, REGISTER_RESERVED, 30, 4, 0)
PPE_FIELD_ENTRY(PIM, REGISTER_DATA, 160, 8, 0)
PPE_FIELD_ENTRY(PIM_HELLO, RAW_DATA, 160, 0, 0)
PPE_FIELD_ENTRY(PIM_REGISTER, REGISTER_B, 1, 0, 7)
PPE_FIELD_ENTRY(PIM_REGISTER, REGISTER_N, 1, 0, 6)
PPE_FIELD_ENTRY(PIM_REGISTER, REGISTER_RESERVED, 30, 0, 0)
PPE_FIELD_ENTRY(PIM_REGISTER, RAW_DATA, 160, 4, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_AF, 8, 0, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_TYPE, 8, 1, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_RSVD, 5, 2, 3)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_SM, 1, 2, 2)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_WC, 1, 2, 1)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_RPT, 1, 2, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_MASK, 8, 3, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_GRP_ADDR, 32, 4, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_SRC_AF, 8, 8, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_SRC_TYPE, 8, 9, 0)
PPE_FIELD_ENTRY(PIM_REGISTER_STOP_V4, ENCODED_SRC_ADDR, 32, 10, 0)
PPE_FIELD_ENTRY(PIM_JOIN_PRUNE, RAW_DATA, 160, 0, 0)
...
PPE_HEADER_ENTRY(PIM_HELLO)
PPE_HEADER_ENTRY(PIM_REGISTER)
PPE_HEADER_ENTRY(PIM_REGISTER_STOP_V4)
PPE_HEADER_ENTRY(PIM_JOIN_PRUNE)
...
#ifdef PPE_PIM_TYPE_ENTRY
PPE_PIM_TYPE_ENTRY(HELLO, 0)
PPE_PIM_TYPE_ENTRY(REGISTER, 1)
PPE_PIM_TYPE_ENTRY(REGISTER_STOP, 2)
PPE_PIM_TYPE_ENTRY(JOIN_PRUNE, 3)
#undef PPE_PIM_TYPE_ENTRY
#endif
