...
PPE_FIELD_ENTRY(ICMP6, TYPE, 8, 0, 0)
PPE_FIELD_ENTRY(ICMP6, CODE, 8, 1, 0)
PPE_FIELD_ENTRY(ICMP6, CHECKSUM, 16, 2, 0)
PPE_FIELD_ENTRY(ICMP6, HEADER_DATA, 32, 4, 0)
PPE_FIELD_ENTRY(ICMP6, PAYLOAD, 8, 8, 0)
...
PPE_IP_PROTOCOL_ENTRY(ICMP6, 58)
