...
#endif
#ifdef VPI_CONFIG_INCLUDE_INTERFACE_MMAP
    { __vpi_config_STRINGIFY_NAME(VPI_CONFIG_INCLUDE_INTERFACE_MMAP), __vpi_config_STRINGIFY_VALUE(VPI_CONFIG_INCLUDE_INTERFACE_MMAP) },
#else
{ VPI_CONFIG_INCLUDE_INTERFACE_MMAP(__vpi_config_STRINGIFY_NAME), "__undefined__" },
#endif
...
#endif
#ifdef VPI_CONFIG_INCLUDE_PYTHON_DEBUG_LOGGING
    { __vpi_config_STRINGIFY_NAME(VPI_CONFIG_INCLUDE_PYTHON_DEBUG_LOGGING), __vpi_config_STRINGIFY_VALUE(VPI_CONFIG_INCLUDE_PYTHON_DEBUG_LOGGING) },
#else
{ VPI_CONFIG_INCLUDE_PYTHON_DEBUG_LOGGING(__vpi_config_STRINGIFY_NAME), "__undefined__" },
#endif
...
#endif
#ifdef VPI_CONFIG_INCLUDE_PCAP_IMMEDIATE_MODE
    { __vpi_config_STRINGIFY_NAME(VPI_CONFIG_INCLUDE_PCAP_IMMEDIATE_MODE), __vpi_config_STRINGIFY_VALUE(VPI_CONFIG_INCLUDE_PCAP_IMMEDIATE_MODE) },
#else
{ VPI_CONFIG_INCLUDE_PCAP_IMMEDIATE_MODE(__vpi_config_STRINGIFY_NAME), "__undefined__" },
#endif
    { NULL, NULL }
};
